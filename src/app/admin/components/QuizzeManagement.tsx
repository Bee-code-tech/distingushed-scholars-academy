...
//   const [type, setType] = useState<'practice' | 'exam' | 'assessment'>('practice')
...
//                   placeholder='Auto-generated (e.g. DSA-######) if left blank'
//                   className='w-full h-11 px-3.5 rounded-xl bg-white border border-slate-200 focus:border-[#002EFF] outline-none text-xs font-bold text-slate-800 shadow-xs'
//                 />
//               </div>
...
//                       className='p-2 text-rose-500 hover:bg-rose-50 rounded-lg transition-colors mt-4 sm:mt-0'
...
//                       className='flex items-center gap-1 text-[10px] font-bold text-[#002EFF] hover:underline'
//                     >
...
//                     <div
//                       key={qIdx}
//                       className='bg-white rounded-xl p-4 border border-slate-200 space-y-3 relative shadow-2xs'
//                     >
//                       <div className='flex items-center justify-between gap-2'>
//                         <span className='text-xs font-black text-[#002EFF]'>
//                           Q{qIdx + 1}.
//                         </span>
...
//                                     .correctAnswer === oldVal
//                                 ) {
//                                   updated[sIdx].questions[
//                                     qIdx
...
//                               className='flex-1 h-8 px-2.5 rounded-md bg-slate-50 border border-slate-200 text-xs text-slate-700 outline-none focus:border-[#002EFF]'
//                             />
//                           </div>
//                         ))}
//                       </div>

//                       {/* Correct Answer Select & Explanation */}
...
//                               setSubjects(updated)
//                             }}
//                             className='w-full h-8 px-2 rounded-md bg-slate-50 border border-slate-200 text-xs font-bold text-slate-800 outline-none focus:border-[#002EFF]'
//                           >
...
//                               setSubjects(updated)
//                             }}
//                             placeholder='Reason behind correct option...'
//                             className='w-full h-8 px-2.5 rounded-md bg-slate-50 border border-slate-200 text-xs text-slate-700 outline-none focus:border-[#002EFF]'
//                           />
//                         </div>
//                       </div>
//                     </div>
...
//               type='submit'
//               disabled={submitting}
//               className='flex items-center gap-2 px-6 py-2.5 bg-[#002EFF] text-white rounded-xl text-xs font-black uppercase tracking-wider hover:bg-blue-700 transition-all shadow-md shadow-blue-200 disabled:opacity-50'
//             >
...
//           <button
//             onClick={onConfirm}
//             className='px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white text-xs font-black uppercase tracking-wider rounded-xl transition-all shadow-md shadow-rose-200'
//           >
//             Confirm Delete
//           </button>
//         </div>
...
// /* ------------------------------------------------------------------ */
// /* Custom Feedback Modal Component                                    */
// /* ------------------------------------------------------------------ */
...
//   return (
//     <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm'>
//       <div className='w-full max-w-sm bg-white rounded-3xl p-6 shadow-2xl border border-slate-100 space-y-4 text-center animate-in fade-in zoom-in-95 duration-150'>
//         <div
...
//         <button
//           onClick={onClose}
//           className={`w-full py-2.5 rounded-xl text-xs font-black uppercase tracking-wider text-white shadow-md transition-all active:scale-95 ${
//             isSuccess
...
export default function QuizzeManagement({ courseId }: Props) {
  const {
    quizzes,
    loading,
    saving,
    ...
    <div className='p-6 max-w-7xl mx-auto space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-xs font-semibold text-slate-500 mt-0.5'>
            Manage and monitor all assessment quizzes
          </p>
        </div>
        <button
          onClick={openCreateModal}
          className='h-11 px-5 rounded-xl bg-[#002EFF] hover:bg-[#0028e0] text-white text-xs font-black uppercase tracking-wider transition-colors shadow-sm cursor-pointer'
        >
          Create Quiz
        </button>
      </div>
      ...
      <div className='flex flex-col sm:flex-row gap-3'>
        <input
          ...
          className='flex-1 h-11 px-4 rounded-xl bg-white border border-slate-200 focus:border-[#002EFF] outline-none text-xs font-bold text-slate-800 shadow-xs'
        />
        <select
          value={typeFilter}
          onChange={(e) =>
            setTypeFilter(e.target.value as 'all' | 'singular' | 'general')
          }
          className='h-11 px-4 rounded-xl bg-white border border-slate-200 focus:border-[#002EFF] outline-none text-xs font-bold text-slate-800 shadow-xs'
        >
      ...
      {loading ? (
        ...
        <div className='p-12 text-center bg-white rounded-2xl border border-slate-200'>
          <p className='text-sm font-bold text-slate-500'>
            No quizzes found. Click "Create Quiz" to set up your first
            evaluation.
          </p>
        </div>
      ) : (
            ...
            >
              <div className='space-y-2'>
                ...
                <div className='flex items-center justify-between pt-2 text-[11px] font-bold text-slate-400'>
                  ...
                  {quiz.accessCode && <span>Code: {quiz.accessCode}</span>}
                </div>
              </div>
              ...
              <div className='flex items-center gap-2 pt-3 border-t border-slate-100'>
                <button
                  onClick={() => openEditModal(quiz, 'questions')}
                  className='flex-1 h-8 rounded-lg bg-slate-900 text-white text-[10px] font-bold uppercase tracking-wider hover:bg-slate-800 transition-colors'
                >
                  Questions
                </button>
                <button
                  onClick={() => openEditModal(quiz, 'details')}
                  className='h-8 px-3 rounded-lg border border-slate-200 text-slate-700 text-[10px] font-bold uppercase hover:bg-slate-50 transition-colors'
                >
                  Edit
                </button>
                <button
                  onClick={() => deleteQuiz(quiz._id)}
                  className='h-8 px-3 rounded-lg border border-rose-200 text-rose-600 text-[10px] font-bold uppercase hover:bg-rose-50 transition-colors'
                >
                  Delete
                </button>
              </div>
