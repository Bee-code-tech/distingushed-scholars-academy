...
// Founder photo lives at public/founder.jpeg.
...
const HIGHLIGHTS = [
  {
    icon: GraduationCap,
    text: 'Medical Student, University of Ibadan',
  },
  {
    icon: BookOpen,
    text: 'Founder & Managing Director, Distinguished Scholars Academy',
  },
  {
    icon: Laptop,
    text: 'Founder, TechUp Academy & Innovations',
  },
  {
    icon: Rocket,
  ...
  {
    icon: Users,
    text: 'Helping students succeed since 2021',
  },
]
    ...
    <section className="w-full py-24 bg-[#f8f9ff] relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-14" data-aos="fade-up">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-gray-900 uppercase tracking-tight">
            The Vision Behind{' '}
            <span className="text-[#002EFF]">DSA</span>
          </h2>
        </div>
              ...
              <div className="space-y-4">
                {HIGHLIGHTS.map((highlight) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-8 h-8 shrink-0 rounded-xl bg-blue-50 flex items-center justify-center">
                        <Icon
                          size={16}
                          strokeWidth={2.2}
                          className="text-[#002EFF]"
                      ...
                      <p className="text-sm font-bold text-gray-700 leading-snug pt-1.5">
                        {highlight.text}
                      </p>
                    </div>
                  )
