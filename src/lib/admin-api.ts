...
//   getRoles: () => adminFetch('/api/admin/roles'),

//   /** Create or update a staff role */
//   upsertRole: (roleData: Record<string, any>) =>
...
//   markManualPayment: (paymentData: {
//     studentId: string
//     amount: number
//     reference?: string
//   }) =>
//     adminFetch('/api/admin/payments/manual', {
//       method: 'POST',
...
//   getAnnouncements: (params?: { scope?: string; track?: string }) => {
...
//     adminFetch('/api/courses', {
//       method: 'POST',
//       body: JSON.stringify(courseData),
//     }),

//   /** Update course / assign tutor */
//   updateCourse: (courseId: string, courseData: Record<string, any>) =>
//     adminFetch(`/api/courses/${encodeURIComponent(courseId)}`, {
//       method: 'PUT',
//       body: JSON.stringify(courseData),
//     }),
...
//   /** Get all quizzes */
//   getAllQuizzes: () => adminFetch('/api/quizzes'),

//   /** Create a new quiz */
//   createQuiz: (quizData: Record<string, any>) =>
//     adminFetch('/api/quizzes', {
//       method: 'POST',
//       body: JSON.stringify(quizData),
//     }),

//   /** Update a quiz */
//   updateQuiz: (quizId: string, quizData: Record<string, any>) =>
//     adminFetch(`/api/quizzes/${encodeURIComponent(quizId)}`, {
//       method: 'PUT',
//       body: JSON.stringify(quizData),
//     }),
...
//   toggleQuizStatus: (quizId: string, status: { isActive: boolean }) =>
//     adminFetch(`/api/quizzes/${encodeURIComponent(quizId)}/status`, {
//       method: 'PATCH',
...
//   upsertProgram: (programData: Record<string, any>) =>
//     adminFetch('/api/programs', {
//       method: 'POST',
...
//     adminFetch<{
//       success: boolean
//       data: { active: boolean; date: string; activatedAt: string }
